...
list_of_manf= ('Acura', 'Alfa', 'Alfa-Romeo',
       'Aston-Martin', 'Audi', 'Bentley', 'Bmw', 'Buick',
       'Cadillac', 'Chevrolet', 'Chrysler', 'Datsun', 'Dodge',
       'Ferrari', 'Fiat', 'Ford', 'Genesis', 'Gmc',
       'Harley-Davidson', 'Honda', 'Hummer', 'Hyundai', 'Infiniti',
       'Jaguar', 'Jeep', 'Kia', 'Lamborghini', 'Land',
       'Land Rover', 'Lexus', 'Lincoln', 'Maserati', 'Mazda',
       'Mclaren', 'Mercedes-Benz', 'Mercury', 'Mini', 'Mitsubishi',
       'Morgan', 'Nissan', 'Not specified', 'Pontiac', 'Porsche',
       'Ram', 'Rolls-Royce', 'Rover', 'Saturn', 'Scion', 'Subaru',
...
#feul
list_of_feul= ('Diesel', 'Electric', 'Flexible', 'Gasoline', 'Hybrid')
feul= st.selectbox('Select The Fuel type on your car:', list_of_feul)

list_of_eng= ('eng.10 Cylinders', 'eng.12 Cylinders', 'eng.3 Cylinders',
       'eng.4 Cylinders', 'eng.5 Cylinders', 'eng.6 Cylinders',
       'eng.8 Cylinders', 'eng.Other')
